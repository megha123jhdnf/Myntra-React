...
import '../Componetss/CSS Files/Home.css'
    ...
    <div id="navbar">
        ...
        <div id="profile">
          <div>
           ...
           <p onClick={()=>router('/profile')}>Profile {userData?.name}</p>
          </div>
          <div>
